    ...
    class NEFF_Theme_Class {
        ...
        public function save_json( $path ) {
            ...
            public function custom_form() {
                ...
                $o = '<section style="max-width:800px;margin:0 auto;" class="block block-text"><form class="protected-post-form" action="' . get_option('siteurl') . '/wp-pass.php" method="post"><h1>'.the_title().'</h1>
