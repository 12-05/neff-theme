...
const styleSRC = "./assets/styles/theme.scss";

// Path to place the compiled CSS file. Default set to root folder.
const styleDestination = "./assets/styles/compiled";
...
const jsVendorDestination = "./assets/scripts/compiled";
...
const jsCustomSRC = "./assets/styles/*.js";

// Path to place the compiled JS custom scripts file.
const jsCustomDestination = "./assets/styles/compiled";
