...
if ($projekte): foreach ($projekte as $projekt): ?>
	        ...
	        <a target="<?php the_field('linkziel');?>" href="<?php echo get_field('externer_link', $projekt->ID) ? get_field('externer_link', $projekt->ID) : get_permalink($projekt->ID); ?>"class="projekt">
