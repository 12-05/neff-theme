...
<?php if(get_field('iframe')) { ?>
        <iframe allow="z-index:95!important;accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen src="<?php the_field('link');?>"></iframe>
<?php } ?>
</section>
<?php if(get_field('iframe')) {?>
    <script>
