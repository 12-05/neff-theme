...
<section class="block block-eventloop">
    <?php 
        ...
        <a href="<?php echo get_permalink($eventPast->ID);?>" class="event">
            ...
            <div class="content">
            <div class="subline"><?php  the_field('typ', $eventPast->ID);?><span class="datum"><?php echo NEFF_EventModel::format_date(get_field('event_start',$eventPast->ID));?> <?php if(get_field('event_ende',$eventPast->ID)) : ?> – <?php echo NEFF_EventModel::format_date(get_field('event_ende',$eventPast->ID));?> <?php endif; ?>  </span></div>
