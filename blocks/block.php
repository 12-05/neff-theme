<section class="block block-block align-<?php the_field('ausrichtung');?>" style="<?php if(get_field('format') === "contain") {echo 'background-size:contain;';}?><?php if(get_field('block_farbig')) {echo 'background-color:var(--main);color:#FFF!important';}?>">
    <div class="image">
